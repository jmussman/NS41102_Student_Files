...
function persistEmployee($sql) {
    ...
    global $errors;
    global $employee_id, $version, $hire_date, $employee_no, $government_no, $first_name, $last_name, $email, $street, $city, $state_province, $postal_code, $country_code, $salary_employee, $rate;
    ...
    try {
        ...
        // The optimistic concurrency 'version' won't have any real affect on an insert, other than the version starts at 1.
...
function validateEmployeeData() {
    ...
    if (!is_numeric($employee_no)) {
        ...
        array_push($errors['employee_no'], "employee number may only contain digits");

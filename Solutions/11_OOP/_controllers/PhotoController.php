...
class PhotoController {
    ...
    public function __construct() {
        ...
        $authorization->requireAuthorization(403);
        ...
        $photoStream = $this->loadEmployeePhoto($employee_id);

        if (!$photoStream) {

            // Internal error, we should have at least retrieved the place holder image.
            ...
            header('Content-Type: ' . $this->typeImage($photoStream));
    ...
    private function loadEmployeePhoto($id) {
    ...
    private function typeImage($photoStream) {
